...
```shell
python generate_psf.py --path_x sample_directory/example_beam_width/measurement_x/data/1750085285.8557956_data.thz --path_y sample_directory/example_beam_width/measurement_y/data/1750163177.929295_data.thz
```
