...
impl IndividualFitsWindow {
    ...
    pub fn show_in_panel(
        ...
        self.show_content(
            ui, popt_xs_left, popt_xs_right, popt_ys_left, popt_ys_right,
            filtered_traces_x_left, filtered_traces_x_right,
            filtered_traces_y_left, filtered_traces_y_right,
            x_positions_left, x_positions_right,
            y_positions_left, y_positions_right,
            center_frequencies,
        );
    }
