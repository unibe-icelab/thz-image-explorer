...
use bevy_egui::egui::{self, DragValue, Stroke, Ui, Vec2};
...
impl Filter for BandPass {
    ...
    fn filter(&mut self, filter_data: &mut ScannedImageFilterData, gui_settings: &mut GuiSettingsContainer) {
        ...
        for i in 0..filter_data.data.len() {
            ...
            apply_adapted_blackman_window(&mut signal, &filter_data.time, &(self.window_width as f32), &(self.window_width as f32));
        }
